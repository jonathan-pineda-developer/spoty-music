package cr.ac.una.spoty.controllers
...
import cr.ac.una.spoty.MainActivity
...
class TrackController(private val activity: MainActivity) {
    ...
    private fun initViews() {
        txtSearch = activity.findViewById(R.id.txtSearch)
        btnSearch = activity.findViewById(R.id.btnSearch)
        listViewItems = activity.findViewById(R.id.listViewItems)
    ...
    init {
            initViews()
            trackAdapter = TrackAdapter(activity.applicationContext, trackList)
            listViewItems?.adapter = trackAdapter

            // Crear la instancia de la base de datos Room
            db = Room.databaseBuilder(
                activity.applicationContext,
                AppDatabase::class.java, "spoty-db"
            ).build()
